...
public class Binary {
    ...
    // Static method to OR two binary values
    public static Binary or(Binary b1, Binary b2) {
        int n1 = Integer.parseInt(b1.getValue(), 2);
        int n2 = Integer.parseInt(b2.getValue(), 2);
        int result = n1 | n2;
        return new Binary(Integer.toBinaryString(result));
    }

    // Static method to AND two binary values
    ...
    // Static method to multiply two binary values
    public static Binary multiply(Binary b1, Binary b2) {
        int n1 = Integer.parseInt(b1.getValue(), 2);
        int n2 = Integer.parseInt(b2.getValue(), 2);
        int product = n1 * n2;
        System.out.println("n1: " + n1 + ", n2: " + n2 + ", product: " + product);
